...
public class DumpJavaLangExtras {

  public static void main(String[] args) throws IOException {
    if (args.length != 1) {
      System.err.println("usage: DumpJavaLangExtras <output jar>");
      System.exit(1);
    }
    ...
    if (isJdk9OrLater()) {
      ...
      compiler.getTask(
          null, fileManager, null, Arrays.asList("--release", "8"), null, null);
    ...
    try (OutputStream os = Files.newOutputStream(Paths.get(args[0]));
      ...
      entries
          ...
          .filter(
              e ->
                  e.getKey().startsWith("java/lang/invoke/")
                      || e.getKey().startsWith("java/lang/annotation/"))
